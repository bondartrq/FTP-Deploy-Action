...
lftp -u $FTP_USERNAME,$FTP_PASSWORD sftp://$FTP_SERVER -e "set ftp:ssl-allow no; mirror --delete --verbose --exclude='.*' --include='^wp-content\/(themes\/.*)?$' --include='^wp-content\/(plugins\/.*)?$' --exclude='^wp-content\/plugins\/jetpack\/.*' --exclude='^wp-content\/plugins\/woocommerce\/.*' -R ./wp-content/themes/soledad-child html/wp-content/themes/soledad-child; quit"
